"""
Django settings for store_catalog project.
...
SECRET_KEY = os.environ.get('SECRET_KEY', 'django-insecure-!ja2))slupw4')
...
WSGI_APPLICATION = 'store_catalog.wsgi.application'
